...
export default function PaymentFailed() {
  ...
  const getFailureDescription = (errorCode) => {
    ...
    return descriptionMap[errorCode] || 'Une erreur inconnue est survenue. Veuillez réessayer ou contacter notre support.';
  };
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="mb-6">
              ...
              {(status?.ErrorCode && status.ErrorCode !== "0") || (status?.errorCode && status.errorCode !== "0") ? (
                <div className="bg-red-50 p-4 rounded-lg mb-4 border border-red-200">
                  <p className="font-semibold text-red-800 mb-1">
                    {getFailureReason(status.ErrorCode || status.errorCode)}
                  </p>
                  <p className="text-red-600 text-sm mt-2">
                    {getFailureDescription(status.ErrorCode || status.errorCode)}
                  </p>
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-gray-500">
                  Vous pouvez réessayer avec le même moyen de paiement ou en choisir un autre.
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 pt-4 border-t border-gray-100 text-center">
              <p className="text-xs text-gray-500">
                Conservez la référence de transaction <span className="font-mono text-gray-700">{mdOrder || 'N/A'}</span> si vous contactez le support.
              </p>
            </div>
          </>
        )}
